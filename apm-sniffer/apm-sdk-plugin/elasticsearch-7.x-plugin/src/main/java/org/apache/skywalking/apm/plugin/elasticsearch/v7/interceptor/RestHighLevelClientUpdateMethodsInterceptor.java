...
import static org.apache.skywalking.apm.plugin.elasticsearch.v7.interceptor.Constants.DB_TYPE;
...
public class RestHighLevelClientUpdateMethodsInterceptor implements InstanceMethodsAroundInterceptor {
    ...
    public void beforeMethod(EnhancedInstance objInst, Method method, Object[] allArguments, Class<?>[] argumentsTypes,
        ...
        if (allArguments[0] instanceof UpdateRequest) {
            ...
            SpanLayer.asDB(span);
        } else if (allArguments[0] instanceof BulkRequest) {
            BulkRequest updateRequest = (BulkRequest) (allArguments[0]);
            ...
            Tags.DB_TYPE.set(span, DB_TYPE);
            Tags.DB_INSTANCE.set(span, "BulkRequest");
            ...
            logger.info("不支持的类型：{}", allArguments[0].getClass().getName());
        }
