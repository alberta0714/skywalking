...
import org.apache.skywalking.apm.plugin.elasticsearch.v7.interceptor.AdapterActionFutureActionGetMethodsInterceptor;
...
//        searchHits = new SearchHits(null, 309L, 0);
        searchHits = new SearchHits(null, new TotalHits(309L
                , TotalHits.Relation.EQUAL_TO), 0);
